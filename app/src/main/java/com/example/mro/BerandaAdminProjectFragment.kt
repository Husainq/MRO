...
class BerandaAdminProjectFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_beranda_admin_project, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment BerandaAdminProjectFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BerandaAdminProjectFragment().apply {
