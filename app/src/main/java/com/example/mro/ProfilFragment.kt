...
import com.example.mro.databinding.FragmentProfilBinding
...
class ProfilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.edtprofil.setOnClickListener{
            val editProfilFragment = UserFragment()
        ...
        **/
        ...
        binding.security.setOnClickListener{
            val editPasswordFragment = ForgotPassFragment()
            val transaction: FragmentTransaction = requireFragmentManager().beginTransaction()
            transaction.replace(R.id.container,editPasswordFragment)
            transaction.commit()
        }
